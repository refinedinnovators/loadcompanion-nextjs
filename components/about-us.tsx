...
const aboutUsContent: CallToActionBlockType = {
  ...
  buttons: [
    ...
    { title: "Watch Demo", href: "https://www.youtube.com/embed/uWPYq7k2wAE", type: "secondary" },
  ],
}
    ...
    <section className="bg-gray-50 py-16 sm:py-24">
      <div className="container px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">{aboutUsContent.title}</h2>
          <p className="mt-6 text-lg leading-8 text-gray-600">{aboutUsContent.description}</p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            {aboutUsContent.buttons.map((button, index) => (
              <Button key={index} asChild variant={button.type === "primary" ? "default" : "outline"}>
