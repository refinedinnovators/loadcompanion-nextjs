...
import { Mail, Map, CloudSun, Calculator, Phone, Star, FileText, Edit, Globe, AtSign } from "lucide-react"
...
export function AnimatedFeatures() {
  ...
  return (
    <section id="features" className="container px-4 sm:px-6 lg:px-8 py-12 sm:py-24">
      <div className="text-center space-y-4 mb-16">
        <p className="text-sm font-semibold tracking-wider uppercase">KEY FEATURES</p>
        <h2 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
          Discover the Load Companion Advantage
        </h2>
        <p className="mt-6 text-xl text-muted-foreground max-w-[800px] mx-auto">
          Load Companion continues to grow alongside your needs. We're dedicated to providing you with a tool that helps
          you save time, streamline your operations, and make your work easier. Here's how Load Companion makes a
          difference:
        </p>
      </div>
        ...
        <div ref={containerRef} className="relative w-full max-w-5xl mx-auto">
          ...
          >
            <g stroke="currentColor" strokeOpacity="0.2" strokeDasharray="1 1">
              ...
              {Array.from({ length: 24 }).map((_, i) => (
                <line key={`v-${i}`} x1={12 + i * 16} x2={12 + i * 16} y2="392" />
              ))}
            </g>
          </svg>
                        ...
                        <TooltipTrigger asChild>
                          <div
                            className={`flex items-center space-x-3 p-2 rounded transition-colors duration-300 cursor-pointer ${
                              index === activeFeature ? "bg-primary/20" : "bg-primary/5 hover:bg-primary/10"
                            }`}
                          >
          ...
          <svg className="absolute -bottom-8 -left-8 w-60 h-16" fill="none" viewBox="0 0 237 35">
            <path
              className="pulse"
              stroke="url(#pulse-1)"
              strokeLinecap="round"
            ...
            />
            <defs>
              <linearGradient id="pulse-1" gradientUnits="userSpaceOnUse" x1="360" x2="200" y1="200" y2="80">
          ...
          <svg className="absolute -top-8 -right-8 w-60 h-16 rotate-180" fill="none" viewBox="0 0 237 35">
            <path
              className="pulse"
              stroke="url(#pulse-2)"
              strokeLinecap="round"
            ...
            />
            <defs>
              <linearGradient id="pulse-2" gradientUnits="userSpaceOnUse" x1="360" x2="200" y1="200" y2="80">
                <stop stopColor="var(--primary)" stopOpacity="0" />
                <stop stopColor="var(--primary)" />
                <stop offset="1" stopColor="var(--primary)" stopOpacity="0" />
              </linearGradient>
