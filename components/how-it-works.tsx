    ...
    <section id="how-it-works" className="py-16 sm:py-24 bg-gray-50">
      <div className="container px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-base font-semibold text-indigo-600 mb-2">{HowItWorksContent.kicker}</h2>
          <h3 className="text-3xl font-bold text-gray-900 sm:text-4xl mb-4">{HowItWorksContent.title}</h3>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">{HowItWorksContent.description}</p>
        </div>
            ...
            {HowItWorksContent.steps.map((step, index) => (
              <motion.div
                ...
                className={`flex items-start space-x-4 p-6 rounded-lg transition-colors ${
                  activeStep === index ? "bg-white shadow-md" : "hover:bg-white hover:shadow-md"
                }`}
